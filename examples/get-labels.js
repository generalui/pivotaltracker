/**
    ...
    node get-labels username password projectId

    https://www.pivotaltracker.com/help/api/rest/v5#Labels
*/
...
tracker.getToken(username, password, function(err, token) {
    ...
    if(err){
        ...
        client.project(projectId).labels.all(function(error, labels) {
