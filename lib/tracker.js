...
var account = require('./resources/account'),
    ...
    fileAttachment = require('./resources/fileattachment'),
...
Client.prototype.fileAttachment = function(attachmentId) {
    return new fileAttachment.Service(this.config, 'download', attachmentId);
};
