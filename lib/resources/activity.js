...
Activity.prototype.inspect = function() {
    var str = '\n';
        ...
        str += 'project: '+util.inspect(this.project)+'\n';
        str += 'projectVersion: '+this.projectVersion+'\n';
        str += 'message: '+this.message+'\n';
        str += 'highlight: '+this.highlight+'\n';
        str += 'occurredAt: '+this.occurredAt+'\n';
        str += 'performedById: '+this.performedById+'\n';
        str += 'performedBy: '+util.inspect(this.performedBy)+'\n';
        str += 'primaryResources: '+util.inspect(this.primaryResources)+'\n';
        str += 'changes: '+util.inspect(this.changes)+'\n';
    return str;
};
