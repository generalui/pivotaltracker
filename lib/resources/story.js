...
function _storyToString() {
    var str = 'kind: '+this.kind+'\n';
        ...
        str += 'integration: '+this.integration+'\n';
        str += 'requestedById: '+this.requestedById+'\n';
        str += 'requestedBy: '+this.requestedBy+'\n';
        str += 'ownedById: '+this.ownedById+'\n';
        str += 'ownedBy: '+this.ownedBy+'\n';
        str += 'labelIds: '+this.labelIds+'\n';
        str += 'labels: '+this.labels+'\n';
        str += 'commentIds: '+this.commentIds+'\n';
        str += 'comments: '+this.comments+'\n';
        str += 'ownerIds: '+this.ownerIds+'\n';
        str += 'owners: '+this.owners+'\n';
        str += 'taskIds: '+this.taskIds+'\n';
        str += 'tasks: '+this.tasks+'\n';
    return str;
}

Story.prototype.toString = _storyToString;
Story.prototype.inspect = _storyToString;
