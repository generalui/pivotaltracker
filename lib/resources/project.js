...
function _storyToString() {
    var str = '\n';
        ...
        str += 'profileContent: '+this.profileContent+'\n';
        str += 'initialVelocity: '+this.initialVelocity+'\n';
        str += 'currentVelocity: '+this.currentVelocity+'\n';
        str += 'version: '+this.version+'\n';
        str += 'weekStartDay: '+this.weekStartDay+'\n';
        str += 'currentIterationNumber: '+this.currentIterationNumber+'\n';
        str += 'pointScale: '+this.pointScale+'\n';
        str += 'iterationLength: '+this.iterationLength+'\n';
        str += 'velocityAveragedOver: '+this.velocityAveragedOver+'\n';
        str += 'numberOfDoneIterationsToShow: '+this.numberOfDoneIterationsToShow+'\n';
        str += 'public: '+this.public+'\n';
        str += 'enableTasks: '+this.enableTasks+'\n';
        str += 'pointScaleIsCustom: '+this.pointScaleIsCustom+'\n';
        str += 'enableIncomingEmails: '+this.enableIncomingEmails+'\n';
        str += 'atomEnabled: '+this.atomEnabled+'\n';
        str += 'showIterationsStartTime: '+this.showIterationsStartTime+'\n';
        str += 'bugsAndChoresAreEstimatable: '+this.bugsAndChoresAreEstimatable+'\n';
        str += 'enabledPlannedMode: '+this.enabledPlannedMode+'\n';
        str += 'hasGoogleDomain: '+this.hasGoogleDomain+'\n';
        str += 'timeZone: '+this.timeZone+'\n';
        str += 'integrationIds: '+this.integrationIds+'\n';
        str += 'integrations: '+this.integrations+'\n';
        str += 'iterationOverrideNumbers: '+this.iterationOverrideNumbers+'\n';
        str += 'iterationOverrides: '+this.iterationOverrides+'\n';
        str += 'membershipIds: '+this.membershipIds+'\n';
        str += 'memberships: '+this.memberships+'\n';
        str += 'epicIds: '+this.epicIds+'\n';
        str += 'epics: '+this.epics+'\n';
        str += 'storyIds: '+this.storyIds+'\n';
        str += 'stories: '+this.stories+'\n';
    return str;
}

Project.prototype.toString = _storyToString;
Project.prototype.inspect = _storyToString;
