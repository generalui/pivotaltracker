...
Iteration.prototype.inspect = function() {
    var str = '\n';
        ...
        str += 'teamStrength: '+this.teamStrength+'\n';
        str += 'length: '+this.length+'\n';
        str += 'planned: '+this.planned+'\n';
        str += 'storyIds: '+util.inspect(this.storyIds)+'\n';
        str += 'stories: '+util.inspect(this.stories)+'\n';
        str += 'start: '+this.start+'\n';
        str += 'finish: '+this.finish+'\n';
    return str;
};
